...
with(this){return _c('p',[_c('strong',[_v("Target user profile")]),_v(": "),_c('strong',[_v("Insurance Agents")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("is based in Singapore")]),_v(" "),_c('li',[_v("has a need to manage a significant number of insurance clients")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Our app helps insurance agents effortlessly manage new and existing clients, offering features for tracking insurance plans and claims, all while staying organised and efficient.\"")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("view the help page")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("add a client")]),_v(" "),_c('td',[_v("keep track of client's contact details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("delete a client")]),_v(" "),_c('td',[_v("remove client's contact details that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("intermediate user")]),_v(" "),_c('td',[_v("edit a client")]),_v(" "),_c('td',[_v("update client's contact when necessary")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("list all clients")]),_v(" "),_c('td',[_v("view all clients in the app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("efficient user")]),_v(" "),_c('td',[_v("find a client by name")]),_v(" "),_c('td',[_v("quickly retrieve client's contact without looking through all my contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("add an insurance plan to a client")]),_v(" "),_c('td',[_v("keep track of the insurance plan the client has purchased")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("delete an insurance plan from a client")]),_v(" "),_c('td',[_v("remove an insurance plan that was previously purchased by the client")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("intermediate user")]),_v(" "),_c('td',[_v("add a claim to an insurance plan purchased by a client")]),_v(" "),_c('td',[_v("keep track of a claim filed against an insurance plan")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("intermediate user")]),_v(" "),_c('td',[_v("delete a claim from an insurance plan purchased by a client")]),_v(" "),_c('td',[_v("remove a wrongly-added claim from an insurance plan")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("intermediate user")]),_v(" "),_c('td',[_v("close a claim filed against an insurance plan purchased by a client")]),_v(" "),_c('td',[_v("mark the claim as closed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("intermediate user")]),_v(" "),_c('td',[_v("list all claims of a client")]),_v(" "),_c('td',[_v("view all claims filed for the various insurance plans purchased by the client")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("frequent user")]),_v(" "),_c('td',[_v("customise the theme of the app")]),_v(" "),_c('td',[_v("change the theme according to my mood and liking")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("clear all contacts from the app")]),_v(" "),_c('td',[_v("quickly reset my app to an empty state")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("basic user")]),_v(" "),_c('td',[_v("exit the app")]),_v(" "),_c('td',[_v("close the app when I am done using it")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("InSUREance")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 01: Add a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to add a new client.")]),_v(" "),_c('li',[_v("System shows successfully added a new client message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Client details are invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows invalid client details error message.")]),_v(" "),_c('li',[_v("1a2. User enters new client details.")])]),_v(" "),_c('p',[_v("Steps 1a1-1a2 are repeated until the data entered is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("1b. Client name is identical to another client that already exists inside the system.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. System sends a warning about identical client to user.")])]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"name":"UC02"}}),_v(" "),_c('strong',[_v("Use case 02: Select a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to select a client.")]),_v(" "),_c('li',[_v("System selects the client.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Client index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows invalid index error message.")]),_v(" "),_c('li',[_v("1a2. User enters new index.")])]),_v(" "),_c('p',[_v("Steps 1a1-1a2 are repeated until the index is valid.")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to list clients.")]),_v(" "),_c('li',[_v("System shows a list of clients.")]),_v(" "),_c('li',[_v("User "),_c('a',{attrs:{"href":"#UC02"}},[_v("select a client")]),_v(" to delete.")]),_v(" "),_c('li',[_v("System deletes the client.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('a',{attrs:{"name":"UC04"}}),_c('strong',[_v("Use case 04: Select an insurance plan")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User selects an insurance plan ID.")]),_v(" "),_c('li',[_v("System has selected the insurance plan ID.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The insurance plan id is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows an error message to user.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("1b. The client does not support the specified insurance plan.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. System shows an error message to user.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The client already has the given insurance plan.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 06: Remove an insurance plan from a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case 07: View all claims of a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. There are no claims for the client.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. An appropriate message about the client having no claims will be shown.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"name":"UC08"}}),_c('strong',[_v("Use case 08: Select a claim of a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Claim ID is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. An appropriate error message will be shown.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case 09: Add a claim to a client")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The claim already exists for the client.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows an error message.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The claim has already been closed for the client.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. System shows that claim is closed with no error.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("The data should be stored locally in a JSON file.")]),_v(" "),_c('li',[_v("The data should be stored in a way that complies with the Personal Data Protection Act, Singapore ["),_c('a',{attrs:{"href":"https://www.pdpc.gov.sg/overview-of-pdpa/the-legislation/personal-data-protection-act"}},[_v("PDPA")]),_v("].")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 clients without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The app should display results within 2 seconds when searching for a client.")]),_v(" "),_c('li',[_v("The app should save the data entered even if it exits unexpectedly while running.")]),_v(" "),_c('li',[_v("The app should have a log of user actions for debugging purposes.")]),_v(" "),_c('li',[_v("The app should help users validate their inputs for their client's claim information as they are adding or deleting the inputs based on known market standards.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Insurance Agent")]),_v(": The user of the app.")]),_v(" "),_c('li',[_c('strong',[_v("Client")]),_v(": A customer who is keen on purchasing an insurance plan or a customer who has purchased at least one insurance plan from the insurance agent.")]),_v(" "),_c('li',[_c('strong',[_v("Insurance Plan ID")]),_v(": A unique ID assigned to the insurance plan by the system.\n"),_c('ul',[_c('li',[_v("Supported insurance plans are: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Basic Insurance Plan")]),_v(" : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("0")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Travel Insurance Plan")]),_v(" : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("1")]),_v(".")])])]),_v(" "),_c('li',[_c('strong',[_v("Valid Insurance Plan ID")]),_v(": An insurance plan ID that exists in the system.")]),_v(" "),_c('li',[_c('strong',[_v("Claim")]),_v(": A formal request by a client for reimbursement for losses that are covered by specific insurance plans.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_v("Download the jar file "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("InSUREance.jar")]),_v(" and copy it into an empty folder.")]),_v(" "),_c('li',[_v("Use the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar InSUREance.jar")]),_v(" to launch the app.")]),_v(" "),_c('li',[_v("Expected: Shows the GUI with a set of sample contacts. The window size may not be optimal.")])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by using the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar InSUREance.jar")]),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing data files")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Delete "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("config.json")]),_v(" and re-launch the app. Expected: New "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("config.json")]),_v(" created. Existing data is not affected.")])]),_v(" "),_c('li',[_c('p',[_v("Delete "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("preferences.json")]),_v(" and re-launch the app. Expected: New "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("preferences.json")]),_v(" created. Existing data is not affected.")])]),_v(" "),_c('li',[_c('p',[_v("Edit the line "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"addressBookFilePath\"")]),_v(" : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"data/addressbook.json\"")]),_v(" to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"addressBookFilePath\"")]),_v(" : "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"data/data.json\"")]),_v(" and re-launch the app. Expected: App starts on clean slate (i.e. with sample data only).")])]),_v(" "),_c('li',[_c('p',[_v("Delete "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("data/")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("data/addressbook.json")]),_v(". Expected: New "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("data/addressbook.json")]),_v(" created. App starts on clean slate (i.e. with sample data only).")])])])]),_v(" "),_c('li',[_c('p',[_v("Dealing with corrupted data files")]),_v(" "),_c('ol',[_c('li',[_v("Add a new field "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"newField\" : \"newField\"")]),_v(" to a client. Expected: All data is lost. The app starts on a clean slate.")]),_v(" "),_c('li',[_v("Remove "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"insurancePlans\"")]),_v(" field from a client. Expected: All data is lost. The app starts on a clean slate.")])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"1-addclaim-id"}},[_v("1. addClaim ID"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-addclaim-id","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("A single claim ID can be added to multiple users. i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("B1100")]),_v(" can be added to both client "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("A")]),_v(" and client "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("B")]),_v(" with no error.\nThis will be fixed in a future version such that claim ID is unique across all clients.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"2-addclaim-amount"}},[_v("2. addClaim amount"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#2-addclaim-amount","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"3-add-command-and-edit-command-does-not-allow-clients-to-have-same-names-yet-allows-two-people-to-have-the-same-contact-details"}},[_v("3. Add command and Edit Command does not allow clients to have same names yet allows two people to have the same contact details"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#3-add-command-and-edit-command-does-not-allow-clients-to-have-same-names-yet-allows-two-people-to-have-the-same-contact-details","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"4-some-common-names-are-not-allowed-to-be-entered"}},[_v("4. Some common names are not allowed to be entered"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#4-some-common-names-are-not-allowed-to-be-entered","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"5-no-wrapping-for-very-long-ui-details"}},[_v("5. No wrapping for very long UI details"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#5-no-wrapping-for-very-long-ui-details","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"6-currently-our-find-function-only-supports-finding-by-name"}},[_v("6. Currently, our find function only supports finding by name"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#6-currently-our-find-function-only-supports-finding-by-name","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"7-flexible-command-keywords"}},[_v("7. Flexible Command Keywords."),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#7-flexible-command-keywords","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Command keywords are currently case-sensitive i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" is a valid command but "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Add")]),_v(" is not. For user convenience, we\nwill make command keywords case-insensitive in a future update by parsing the prefixes differently.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Most of the difficulty in our project stems from the challenge of trying to "),_c('strong',[_v("integrate mutable objects into an established immutable project")]),_v(". While we knew the project was developed based on the principles of immutability, we felt in our case, it was better to use mutable objects for insurance plans and claims as the lists and claims were objects that were changed frequently unlike details that were currently found in addressbook level-3 such as names, emails and phone numbers. This would allow future developers to also work more easily with the given code base as adding and removing plans, introducing new insurance related features would be much more easily implemented with less code. We also wanted to challenge ourselves to see if this was possible at all.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('strong',[_v("biggest hurdle")]),_v(" to overcome with this project was "),_c('strong',[_v("modifying the testing methods")]),_v(". The test methods were mostly designed for immutable objects and there were strict tests like JsonSerializableAddressBookTest which were the most difficult to pass. This is because the test compares the hardcoded file of clients to a generated file of clients. However, at first since we were making the objects mutable, the generated file becomes different in comparison to the hardcoded file ONLY during the full testing sequence. When the test was done individually, the test passes. We scratched our heads over this for a very long time and eventually managed to solve this problem by changing the equals method for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Client")]),_v(" object and also the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("InsurancePlansManager")]),_v(" object.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("However, "),_c('strong',[_v("this fix initially caused other tests break")]),_v(". This includes tests like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addClaimCommandTest.java")]),_v(" as the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("assertCommandSuccess")]),_v(" method in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TestUtil.java")]),_v(" did not compare actual and expected models correctly. This meant that even if there were some changes in the insurance plan manager, sometimes the two models are evaluated as equal to each other. We then had to create new assert methods for commands (like assertInsuranceCommandSuccess) for all the insurance plan related objects.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Our implementations were at "),_c('strong',[_v("least as difficult compared to half of AB-3 effort")]),_v(". While we did not have to create many huge structures from scratch like the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ModelManager")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(" components, we had to work with moving parts compared to AB-3. AB-3 does not support any form in automatic sorting. However, since we wanted a quick and easy way for insurance managers to view their most critical claims, we implemented an automatic sorting of claims for each client to show their respective open claims first.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 20:22:11 GMT+8]")])])])}
}];
