...
with(this){return _c('h3',{attrs:{"id":"4-flexible-command-keywords"}},[_v("4. Flexible Command Keywords."),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#4-flexible-command-keywords","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Command keywords are currently case-sensitive i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" is a valid command but "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Add")]),_v(" is not. For user convenience, we will make command keywords case-insensitive in a future update by parsing the prefixes differently.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sun, 10 Nov 2024, 23:32:03 GMT+8]")])])])}
}];
