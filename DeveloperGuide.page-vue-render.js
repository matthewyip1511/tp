...
with(this){return _c('ul',[_c('li',[_v("has a need to manage a significant number of insurance clients")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to add a new client")]),_v(" "),_c('li',[_v("System checks new client details.")]),_v(" "),_c('li',[_v("System assigns client an ID.")]),_v(" "),_c('li',[_v("System shows successfully added a new client message.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. Client details are invalid.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. System shows invalid client details error message.")]),_v(" "),_c('li',[_v("2a2. User enters new client details.")])]),_v(" "),_c('p',[_v("Steps 2a1-2a2 are repeated until the data entered is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])]),_v(" "),_c('li',[_c('p',[_v("2b. Client name is identical to another client that already exists inside the system.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. System sends a warning about identical client to user.")])]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User selects an insurance plan ID.")]),_v(" "),_c('li',[_v("System checks if the ID is valid.")]),_v(" "),_c('li',[_v("System has selected the insurance plan ID.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The client does not have the specified insurance plan.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. System shows an error message to user.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sun, 10 Nov 2024, 17:12:35 GMT+8]")])])])}
}];
